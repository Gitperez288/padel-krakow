    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <section className="bg-orange-700 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">{t("👋 Who We Are")}</h1>
          <p className="text-lg md:text-xl text-stone-200 max-w-2xl mx-auto">{t("We are a small, passionate team on a mission to build the most welcoming padel community in Kraków and Małopolska. People first, always.")}</p>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-stone-900 mb-2">{t("The Founders")}</h2>
            <p className="text-gray-600 max-w-xl mx-auto">{t("Padel Kraków Community was started by two friends who fell in love with Padel and wanted to share it with the whole region. The group started when there was just one court in Cracow!")}</p>
          </div>
            ...
            {founders.map((person) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-500 text-sm leading-relaxed">{t(person.bio)}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="text-2xl font-bold text-stone-900 mb-4">{t("Our Mission")}</h2>
          <p className="text-gray-600 text-lg leading-relaxed">{t("We believe padel is more than a sport; it's about people, connections, and community. Our goal is to make padel accessible and enjoyable for everyone in Kraków and Małopolska, from absolute beginners to seasoned players. More details about our story coming soon.")}</p>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-bold text-stone-900 mb-2">{t("Our Collaborators")}</h2>
            <p className="text-gray-600 max-w-xl mx-auto">{t("We have a growing team of amazing people contributing to the blog, community events, and everything in between.")}</p>
          </div>
            ...
            {collaborators.map((collab) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-500 text-sm leading-relaxed whitespace-pre-line">{t(collab.bio)}</p>
                </div>
              </div>
            ))}
          </div>
