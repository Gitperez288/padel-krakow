        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 space-y-8 text-gray-700 leading-relaxed">
          <section>
            ...
            <p>
              ...
              players in Kraków and Małopolska, Poland, independently managed by
          ...
          <section>
            ...
            <p>
              Administrator account data is retained for as long as the account is
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">7. WhatsApp and external platforms</h2>
            <p>
              Our community also operates via WhatsApp groups. Any personal data you
              share within those groups (name, phone number, messages) is subject to{" "}
              <a
