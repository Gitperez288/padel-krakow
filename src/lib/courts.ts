...
export type CourtExtended = Omit<Court, "lat" | "lng"> & {
  ...
  instagram?: string;
  website?: string;
  bookingSearchName?: string;
  practical?: { en: string; pl: string; source: string };
  area?: "krakow" | "nearby" | "region";
};

// ---------- COURT DATA ----------
export const baseCourts: CourtExtended[] = [
  { id: "ahoj", area: "nearby", photo: "/media/courts/ahoj.webp", name: "Ahoj Padel", address: "Staniątki 703B, 32-005 Niepołomice",
    ...
    bookingUrl: "https://padelmates.se/club/ahojpadel",
    practical: { en: "Racket and ball rental is available. Check current rental and court prices on the club website.", pl: "Można wypożyczyć rakietę i piłki. Aktualne ceny sprzętu i kortów sprawdzisz na stronie klubu.", source: "https://ahojpadel.pl/" },
  ...
  { id: "bajada", photo: "/media/courts/bajada.webp", name: "Bajada Sports Club", address: "Tyniecka 215, 30-381 Kraków",
    ...
    booking: "Tenis4U App",
    bookingUrl: "https://app.tenis4u.pl/court/421",
    practical: { en: "Two indoor doubles courts, one indoor singles court and two outdoor doubles courts. Equipment rental, changing rooms and parking are listed by the club.", pl: "Dwa kryte korty deblowe, jeden kryty singlowy i dwa deblowe na zewnątrz. Klub podaje dostępność wypożyczalni sprzętu, szatni i parkingu.", source: "https://app.tenis4u.pl/court/421" },
  ...
  { id: "fame", photo: "/media/courts/fame.webp", name: "Fame Sport Club", address: "Jana Dekerta 21, 30-703 Kraków",
    link: "https://maps.google.com/?q=Fame+Sport+Club+Kraków",
    doubles: 2, indoor: "mixed", lat: 50.0467165, lng: 19.9649943,
    booking: "Tenis4U App",
    bookingUrl: "https://app.tenis4u.pl/court/104",
  ...
  { id: "gardenpadel", photo: "/media/courts/gardenpadel.webp", name: "Garden Padel", address: "Walerego Eljasza-Radzikowskiego 109, 31-342 Kraków",
    ...
    booking: "Tenis4U App",
    bookingUrl: "https://app.tenis4u.pl/court/483",
    instagram: "https://www.instagram.com/gardenpadel_krakow/" },
  { id: "libertow", area: "nearby", photo: "/media/courts/libertow.webp", name: "Libertów Padel Club", address: "Przylesie 41, 30-444 Libertów",
    link: "https://maps.google.com/?q=Przylesie+41+Libertów",
    doubles: 2, indoor: true,
    booking: "Tenis4U App",
    bookingUrl: "https://app.tenis4u.pl/court/496",
  ...
  { id: "morelowa", photo: "/media/courts/morelowa.webp", name: "Morelowa34", address: "Morelowa 34, 30-222 Kraków",
    ...
    booking: "Tenis4U App",
    bookingUrl: "https://app.tenis4u.pl/court/407",
    instagram: "https://www.instagram.com/morelowa34padellounge/" },
  { id: "padelarena", area: "region", photo: "/media/courts/padelarena.webp", name: "Padel Arena Limanowa", address: "Marka 34A, 34-600 Limanowa",
    link: "https://maps.google.com/?q=Marka+34A+Limanowa",
    doubles: 3, indoor: false,
    booking: "Playpadel.com.pl",
    bookingUrl: "https://playpadel.com.pl/korty/1#rezerwacje",
    practical: { en: "Outdoor courts with lighting and a relaxation area. Current prices are available on the club booking page.", pl: "Korty odkryte z oświetleniem i strefą relaksu. Aktualny cennik znajdziesz na stronie rezerwacji klubu.", source: "https://playpadel.com.pl/korty/1" },
    instagram: "https://www.instagram.com/padel_arena_limanowa/" },
  { id: "padelfactory", area: "region", photo: "/media/courts/padelfactory.webp", name: "Padel Factory Nowy Targ", address: "osiedle Bohaterów Tobruku 38, 34-400 Nowy Targ",
  ...
  { id: "padelhouse", photo: "/media/courts/padelhouse.webp", name: "Padel House", address: "Rzemieślnicza 20A, 30-363 Kraków",
    ...
    booking: "Tenis4U App",
    bookingUrl: "https://app.tenis4u.pl/court/480",
    instagram: "https://www.instagram.com/padelhouse_krakow/" },
  { id: "padelspot", area: "nearby", photo: "/media/courts/padelspot.webp", name: "Padel Spot", address: "ul. Koralowa 10, Modlniczka",
    ...
    booking: "Tenis4U App",
    bookingUrl: "https://app.tenis4u.pl/", bookingSearchName: "Padel SPOT",
  ...
  { id: "sao", photo: "/media/courts/sao.webp", name: "SAO Sports Hub", address: "Piastowska 26, 30-065 Kraków",
    ...
    booking: "Tenis4U App",
    bookingUrl: "https://app.tenis4u.pl/court/204",
    instagram: "https://www.instagram.com/saosportshub/" },
  { id: "skawina", area: "nearby", photo: "/media/courts/skawina.webp", name: "Squash & Padel Skawina", address: "Józefa Piłsudskiego 7, 32-050 Skawina",
    link: "https://maps.google.com/?q=Squash+%26+Padel+Skawina",
    doubles: 1, indoor: false, lat: 49.9720952, lng: 19.8056069,
    booking: "Tenis4U App",
    bookingUrl: "https://app.tenis4u.pl/", bookingSearchName: "Squash&Padel",
